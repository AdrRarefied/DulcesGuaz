        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <a
              ...
              className="flex items-start gap-4 bg-background rounded-2xl p-6 border border-border hover:shadow-md transition-shadow"
            >
              ...
              <div>
                ...
                <span className="text-sm text-accent font-semibold">Escríbenos ahora →</span>
              </div>
            </a>
